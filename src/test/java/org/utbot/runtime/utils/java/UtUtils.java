...
public final class UtUtils {
    ...
    public static void setField(Object object, String fieldClassName, String fieldName, Object fieldValue) throws ClassNotFoundException, NoSuchFieldException, NoSuchMethodException, IllegalAccessException, java.lang.reflect.InvocationTargetException {
        ...
        java.lang.reflect.Method methodForGetDeclaredFields147329990446600 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
        methodForGetDeclaredFields147329990446600.setAccessible(true);
        java.lang.reflect.Field[] allFieldsFromFieldClass147329990453600 = (java.lang.reflect.Field[]) methodForGetDeclaredFields147329990446600.invoke(java.lang.reflect.Field.class, false);
        modifiersField = java.util.Arrays.stream(allFieldsFromFieldClass147329990453600).filter(field1 -> field1.getName().equals("modifiers")).findFirst().get();
    ...
    public static void setStaticField(Class<?> clazz, String fieldName, Object fieldValue) throws NoSuchFieldException, IllegalAccessException {
        ...
        try {
            ...
            java.lang.reflect.Method methodForGetDeclaredFields147329991183300 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
            methodForGetDeclaredFields147329991183300.setAccessible(true);
            java.lang.reflect.Field[] allFieldsFromFieldClass147329991184000 = (java.lang.reflect.Field[]) methodForGetDeclaredFields147329991183300.invoke(java.lang.reflect.Field.class, false);
            modifiersField = java.util.Arrays.stream(allFieldsFromFieldClass147329991184000).filter(field1 -> field1.getName().equals("modifiers")).findFirst().get();
    ...
    public static Object getFieldValue(Object obj, String fieldClassName, String fieldName) throws ClassNotFoundException, NoSuchMethodException, java.lang.reflect.InvocationTargetException, IllegalAccessException, NoSuchFieldException {
        ...
        java.lang.reflect.Method methodForGetDeclaredFields147329992175400 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
        methodForGetDeclaredFields147329992175400.setAccessible(true);
        java.lang.reflect.Field[] allFieldsFromFieldClass147329992175900 = (java.lang.reflect.Field[]) methodForGetDeclaredFields147329992175400.invoke(java.lang.reflect.Field.class, false);
        modifiersField = java.util.Arrays.stream(allFieldsFromFieldClass147329992175900).filter(field1 -> field1.getName().equals("modifiers")).findFirst().get();
    ...
    public static Object getStaticFieldValue(Class<?> clazz, String fieldName) throws IllegalAccessException, NoSuchFieldException {
        ...
        do {
            try {
                ...
                java.lang.reflect.Method methodForGetDeclaredFields147329992902800 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
                methodForGetDeclaredFields147329992902800.setAccessible(true);
                java.lang.reflect.Field[] allFieldsFromFieldClass147329992903200 = (java.lang.reflect.Field[]) methodForGetDeclaredFields147329992902800.invoke(java.lang.reflect.Field.class, false);
                modifiersField = java.util.Arrays.stream(allFieldsFromFieldClass147329992903200).filter(field1 -> field1.getName().equals("modifiers")).findFirst().get();
    ...
    private static java.lang.invoke.MethodHandles.Lookup getLookupIn(Class<?> clazz) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, java.lang.reflect.InvocationTargetException {
        ...
        java.lang.reflect.Method methodForGetDeclaredFields147329999828900 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
        methodForGetDeclaredFields147329999828900.setAccessible(true);
        java.lang.reflect.Field[] allFieldsFromFieldClass147329999830100 = (java.lang.reflect.Field[]) methodForGetDeclaredFields147329999828900.invoke(java.lang.invoke.MethodHandles.Lookup.class, false);
        allowedModes = java.util.Arrays.stream(allFieldsFromFieldClass147329999830100).filter(field1 -> field1.getName().equals("allowedModes")).findFirst().get();


        java.lang.reflect.Method methodForGetDeclaredFields147329999842600 = Class.class.getDeclaredMethod("getDeclaredFields0", boolean.class);
        methodForGetDeclaredFields147329999842600.setAccessible(true);
        java.lang.reflect.Field[] allFieldsFromFieldClass147329999842800 = (java.lang.reflect.Field[]) methodForGetDeclaredFields147329999842600.invoke(java.lang.invoke.MethodHandles.Lookup.class, false);
        allModesField = java.util.Arrays.stream(allFieldsFromFieldClass147329999842800).filter(field1 -> field1.getName().equals("ALL_MODES")).findFirst().get();
